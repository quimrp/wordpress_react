        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            ...
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Nuestro asistente virtual te atendera 24/7 con solo unas fotos y las medidas aproximadas te dare un presupuesto rapido y sin compromiso. </p>
              ...
              <div className="relative bg-[#343E4E] rounded-[36px] shadow-2xl border border-gray-300"
                ...
                <div className="w-full h-full rounded-[36px] overflow-hidden">
                  <div className="absolute top-2 left-1/2 -translate-x-1/2 flex flex-col items-center z-10">
                    <div className="w-20 h-3 bg-black/30 rounded-full mb-1"></div>
                    <div className="w-6 h-1.5 bg-black/20 rounded-full"></div>
                  </div>
                  <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-10">
                    <div className="w-10 h-10 bg-black/20 rounded-full border-2 border-white"></div>
                  </div>
                  <WhatsAppChatAuto />
                </div>
              </div>
